...
function privacyPolicy() {
  return (
    <div className='max-w-5xl mx-auto'>
      <div>
        {`Thank you for choosing to be part of our community at The Future Group
      ...
      thefuturegroupinfo@gmail.com. When you visit our website
      http://www.thefuturegp.com (the "Website"), and more generally, use any of
      our services (the "Services", which include the Website), we appreciate
      ...
      <div>
        ...
        please discontinue use of our Services immediately. This privacy notice
        applies to all information collected through our Services (which, as
        described above, includes our Website), as well as, any related
        services, sales, marketing or events. Please read this privacy notice
      ...
      collect information through cookies and similar technologies. The
      information we collect includes: Log and Usage Data. Log and usage data is
      ...
      record in log files. Depending on how you interact with us, this log data
      may include your IP address, device information, browser type and settings
      and information about your activity in the Website (such as the date/time
      ...
      'crash dumps') and hardware settings). Device Data. We collect device data
      such as information about your computer, phone, tablet or other device you
      use to access the Website. Depending on the device used, this device data
      ...
      and system configuration information, Location Data. We collect location
      ...
      aspects of the Services. 2. HOW DO WE USE YOUR INFORMATION? In Short: We
      ...
      legal obligations, and/or your consent. We use personal information
      collected via our website for a variety of business purposes described
      below. We process your personal information for these purposes in reliance
      on our legitimate business interests, in order to enter into or perform a
      ...
      to each purpose listed below. We use the information we collect or
      receive: To facilitate account creation and logon process. If you choose
      ...
      for the performance of the contract. To post testimonials. We post
      ...
      testimonial, please contact us at thefuturegroupinfo@gmail.com and be sure
      ...
      accounts. We may use your information for the purposes of managing our
      account and keeping it in working order. To send administrative
      ...
      effectiveness. 3. WILL YOUR INFORMATION BE SHARED WITH ANYONE? In Short:
      We only share information with your consent, to comply with laws, to
      provide you with services, to protect your rights, or to fulfill business
      obligations. We may process or share your data that we hold based on the
      following legal basis: Consent: We may process your data if you have given
      us specific consent to use your personal information for a specific
      purpose. Legitimate Interests: We may process your data when it is
      ...
      contract. Legal Obligations: We may disclose your information where we are
      ...
      enforcement requirements).Vital Interests: We may disclose your
      ...
      your personal information in the following situations: Business Transfers.
      We may share or transfer your information in connection with, or during
      negotiations of, any merger, sale of company assets, financing, or
      acquisition of all or a portion of our business to another company. 4. DO
      WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES? In Short: We may use
      ...
      <div>
        {`5. DO WE USE GOOGLE MAPS PLATFORM APIS? In Short: Yes, we use Google
        Maps Platform APIs for the purpose of providing better service. This
        Website uses Google Maps Platform APIs which are subject to Google’s
        Terms of Service. You may find the Google Maps Platform Terms of Service
        here. To find out more about Google’s Privacy Policy, please refer to
      ...
      <div>
        ...
        your own. Our servers are located in. If you are accessing our Website
        ...
        INFORMATION BE SHARED WITH ANYONE?" above), in and other countries. If
      ...
      <div>
        ...
        your personal information for longer than 2 years. When we have no
      ...
      <div>
        ...
        dependent’s use of the Website. If we learn that personal information
      ...
      <div>
        ...
        https://www.edoeb.admin.ch/edoeb/en/home.html. Cookies and similar
      ...
      <div>
        ...
        collected. At this stage no uniform technology standard for recognizing
      ...
      <div>
        ...
        California, and have a registered account with the Website, you have the
        right to request removal of unwanted data that you publicly post on the
        Website. To request removal of such data, please contact us using the
